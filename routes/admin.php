...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => 'web'], function () {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'batchs'], function () {
            ...
            Route::post('/{id}/update', 'BatchController@update');
            Route::get('/{id}/delete', 'BatchController@destroy');
        });
        ...
        Route::group(['prefix' => 'enrollments'], function () {
            ...
            Route::get('/getUnits/{course_id}', 'EnrollmentController@getUnits');
        ...
        Route::group(['prefix' => 'course_instruction'], function () {
            Route::get('/list', 'CourseInstructionController@index');
            Route::get('/add', 'CourseInstructionController@add');
            Route::post('/store', 'CourseInstructionController@store');
            Route::get('/edit/{id}', 'CourseInstructionController@edit');
            Route::get('/{sale_id}/block-access', 'CourseInstructionController@blockAccess');
            Route::get('/{sale_id}/enable-access', 'CourseInstructionController@enableAccess');
            Route::get('/export', 'CourseInstructionController@exportExcel');
            Route::get('/{id}/delete', 'CourseInstructionController@destroy');
        });
    });
});
