...
<head>
    ...
    {{-- vue js --}}
    <script src="{{ asset('ViewerJS/vue-select.js') }}"></script>
    <script defer src="{{ asset('ViewerJS/compact-layout.js') }}"></script>
    <script src="{{ asset('ViewerJS/vue.js') }}"></script>
    <script src="{{asset('ViewerJS/vuejs-datepicker.min.js')}}"></script>
