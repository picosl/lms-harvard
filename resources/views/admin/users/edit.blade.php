                            ...
                            <div class="row">
                                ...
                                <form action="/admin/users/{{ $user->id .'/update' }}" method="Post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="username" type="text" class="form-control @error('email') is-invalid @enderror @error('mobile') is-invalid @enderror" id="username"   value="{{ !empty($user) ? $user->email : old('email') }}" aria-describedby="emailHelp">
                                            @error('email')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
