<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="/admin">
                ...
                @if(!empty($generalSettings['logo']))
                    <img src="{{ $generalSettings['logo'] }}" class="img-cover"  style="height:120px; width: 90%; padding-top: 0px;object-fit: contain;" alt="site logo">
                @else
        ...
        <ul class="sidebar-menu">
            ...
            @endif
            @can('admin_batchs')
                <li class="nav-item dropdown {{ (request()->is('admin/batchs*') and !request()->is('admin/webinars/comments*')) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-graduation-cap"></i>
                        <span>{{ _('Batch Information') }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        @can('admin_batch_list')
                            <li class="{{ (request()->is('admin/batchs')) ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['batchs']) and $sidebarBeeps['batchs']) beep beep-sidebar @endif" href="/admin/batchs">{{ _('Batchs') }}</a>
                            </li>
                        ...
                        @can('admin_batch_create')
                            <li class="{{ (request()->is('admin/batchs/create')) ? 'active' : '' }}">
                                <a class="nav-link" href="/admin/batchs/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
            ...
            {{--Course Instruction--}}
            <!--@can('course_instruction_view')
                <li class="nav-item dropdown {{ (request()->is('admin/course_instruction*')) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-th"></i>
                    ...
                    <ul class="dropdown-menu">
                        @can('course_instruction_view')
                            <li class="{{ (request()->is('admin/course_instruction/list')) ? 'active' : '' }}">
                                <a class="nav-link" href="/admin/course_instruction/list">List</a>
                            </li>
                        @endcan

                        @can('course_instruction_view')
                            <li class="{{ (request()->is('admin/course_instruction/add')) ? 'active' : '' }}">
