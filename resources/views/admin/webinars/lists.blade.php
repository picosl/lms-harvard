                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="title" type="text" class="form-control" value="{{ request()->get('title') }}" placeholder="code">
                                </div>
                            </div>
                                    ...
                                    @foreach($webinars as $webinar)
                                        <tr class="text-center">
                                            ...
                                            <td width="18%" class="text-left">
                                                <a class="text-primary mt-0 mb-1 font-weight-bold" href="{{ $webinar->getAdminUrl() }}">{{ $webinar->title }}</a>
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                        ...
                                                        @can('admin_webinar_statistics')
                                                            <a href="/admin/webinars/{{ $webinar->id }}/statistics" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 " title="{{ trans('admin/main.students') }}">
