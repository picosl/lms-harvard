                        ...
                        @foreach($assignments as $assignment)
                            ...
                            <tr>
                                <td class="text-left">
                                    ...
                                    <span class="d-block font-weight-500 text-gray">{{ $assignment->webinar->title ?? '' }}({{ $assignment->webinar->code ?? "" }})</span>
                                </td>
                                
                                <td class="align-middle">
                                    <span class="font-weight-500">{{ $assignment->chapter->title ?? "" }}({{ $assignment->chapter->code ?? "" }})</span>
                                </td>
                                
                                <td class="align-middle">
                                    <span class="font-weight-500">{{ $assignment->title ?? '' }}</span>
                                </td>
                                
                                <td class="align-middle">
                                    <span class="font-weight-500">{{ count($assignment->attachments) ? getFileExtension($assignment->attachments[0]->attach) : ''}}</span>
                                </td>
                                ...
                                <td class="align-middle text-right">
                                    @can('admin_reviews_status_toggle')
                                        <a href="/admin/assignments/{{ $assignment->id }}/students" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('public.students') }}">
