                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <label class="form-check-label">
                                <input type="radio" id="marking_system" name="ajax[{{ !empty($assignment) ? $assignment->id : 'new' }}][radio]" value="grading" onclick="check(this.value)" {{ !empty($assignment) ? (($assignment->marking_type == "1") ? "checked" : "") : "" }}> Grading</input>
                            </label><br>
                            <label class="form-check-label">
                                <input type="radio" id="marking_system" name="ajax[{{ !empty($assignment) ? $assignment->id : 'new' }}][radio]" value="others" onclick="check(this.value)" {{ !empty($assignment) ? (($assignment->marking_type == "0") ? "checked" : "") : "" }}> Satisfied/Unsatisfied</input>
                            </label>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="form-group grade">
                            <label class="input-label">{{ trans('quiz.grade') }}<span style="color:red;">*</span></label>
                        ...
                        <div class="form-group pass_grade">
                            <label class="input-label">{{ trans('update.pass_grade') }}<span style="color:red;">*</span></label>
                        ...
                        {{--Deadline--}}
                        <div class="form-group">
                            <label class="input-label">{{ trans('update.deadline') }}(in days)</label>
                        ...
                        <div class="form-group mt-20">
                            <div class="d-flex align-items-center justify-content-between">
                                <label class="cursor-pointer input-label" for="assignmentStatusSwitch{{ !empty($assignment) ? $assignment->id : '_record' }}">{{ trans('public.active') }}<span style="color:red;">*</span></label>
