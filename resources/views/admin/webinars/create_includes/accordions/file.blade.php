    ...
    <li data-id="{{ !empty($chapterItem) ? $chapterItem->id :'' }}" class="accordion-row bg-white rounded-sm border border-gray300 mt-20 py-15 py-lg-30 px-10 px-lg-20">
        <div class="d-flex align-items-center justify-content-between " role="tab" id="file_{{ !empty($file) ? $file->id :'record' }}">
            ...
            <span class="chapter-icon chapter-content-icon mr-10">
                ...
                <div class="font-weight-bold text-dark-blue d-block cursor-pointer">{{ !empty($file) ? $file->title . ($file->accessibility == 'free' ? " " : '') : trans('public.add_new_files') }}</div>
            </div>
            ...
            <div class="panel-collapse text-gray">
                <div class="js-content-form file-form" data-action="/admin/files/{{ !empty($file) ? $file->id . '/update' : 'store' }}">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="form-group mt-20">
                                ...
                                <ul class="myclass">
                                    <li>
                                        <label>
                                            <input type="checkbox" name="permissions[]" value="2 " {{!empty($file) ? ($file->admin_permission == 1 ? ' checked' : '') : 'new'  }}  class="pl"><span>&nbsp; Admin</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label>
                                            <input type="checkbox" name="permissions[]" value="4" {{!empty($file) ? ($file->teacher_permission == 1 ? ' checked' : '') : 'new'  }} class="pl"><span>&nbsp; Instructor</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label>
                                            <input type="checkbox" name="permissions[]" value="1" {{!empty($file) ? ($file->student_permission == 1 ? ' checked' : '') : 'new'  }} class="pl"><span>&nbsp; Student</span>
                                        </label>
                                    </li>
                                </ul>                          
                            </div>
                            
                            {{--File Type  1=Classroom Learing Guide 2= Student Handbook 3= Assesment --}}
                            <div class="form-group mt-20">
                                <label class="input-label">Types of File</label>
                                <select name="upload_file_type" class="form-control " id="upload_file_type" required>
                                    <option value="1" @if(!empty($file) and $file->upload_file_type == 1) selected @endif>Classroom Learning Guide</option>
                                    <option value="2" @if(!empty($file) and $file->upload_file_type == 2) selected @endif>Student Handbook</option>
                                    {{--<option value="3" @if(!empty($file) and $file->upload_file_type == 3) selected @endif>Assesment</option>--}}
                                </select>
                                <div class="invalid-feedback"></div>                          
                            </div>
                    ...
                    <div class="mt-30 d-flex align-items-center">
                        <button type="button" id="saveFileID"  class="js-save-file btn btn-sm btn-primary">{{ trans('public.save') }}</button>
