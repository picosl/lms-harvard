                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="/admin/webinars/{{ !empty($webinar) ? $webinar->id.'/update' : 'store' }}" id="webinarForm" class="webinar-form" >
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="code" value="{{ !empty($webinar) ? $webinar->code : old('code') }}" class="form-control @error('title')  is-invalid @enderror" placeholder=""/>
                                                @error('code')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            {{--Course Teacher--}}
                                            <div class="form-group mt-15 ">
                                                <label class="input-label d-block">{{ trans('admin/main.select_a_instructor') }}<span style="color:red;">*</span></label>
                                                ...
                                                >
                                                    ...
                                                    @if(count($teachers) > 0)
                                                        @foreach($teachers as $teacher)
                                                            <option value="{{ $teacher->id }}" <?php echo (!empty($webinar) && $webinar->teacher->id == $teacher->id) ? 'selected' : ''; ?>>{{ $teacher->full_name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                ...
                                @if(!empty($webinar))
                                    ...
                                    {{--Learning Materials+Company Logo--}}
                                    ...
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h2 class="section-title after-line">{{-- trans('public.quiz_certificate') --}}Quiz</h2>
