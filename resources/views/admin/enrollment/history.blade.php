                            ...
                            <table class="table table-striped font-14" id="datatable-details">
                                <thead>
                                    ...
                                    @foreach($sales as $sale)
                                        <tr>
                                            <td>
                                                <span class="d-block font-16 font-weight-500 text-dark-blue">{{ $sale->id }}</span>
                                            </td>

                                            <td>
                                                <span class="font-weight-500">{{ $sale->buyer!=null? $sale->buyer->full_name:""  }}</span>
                                            </td>

                                            <td>
                                                <span class="font-weight-500">{{ $sale->item_seller }}</span>
                                            </td>

                                            <td>
                                                <span>{{ $sale->item_title }}</span>
                                            </td>
                                            ...
                                            <td>
                                                {{ date('d M Y i:s', $sale->created_at) }}
                                            </td>
                                            ...
                                            <td class="align-middle text-right">
                                                ...
                                                <a href="/admin/financial/sales/{{ $sale->id }}/invoice" target="_blank" title="Invoice"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                <button class="btn-transparent text-primary trigger--fire-modal-1" data-confirm="Are you sure? | Do you want to continue?" data-confirm-href="/admin/enrollments/{{ $sale->id }}/block-access" data-confirm-text-yes="Yes" data-confirm-text-cancel="Cancel" data-toggle="tooltip" data-placement="top" title="" data-original-title="Block Access">
