                    ...
                    <div class="hero-inner">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center justify-content-between">
                            @can('admin_general_dashboard_quick_access_links')
                                <div>
                                    <p class="lead">{{--trans('admin/main.welcome_card_text')--}}Welcome to Wonder LMS</p>
            ...
            @can('admin_general_dashboard_new_sales')
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <a href="/admin/financial/sales" class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{-- trans('admin/main.new_sale') --}}Toal Active Courses</h4>
                            </div>
                            <div class="card-body">
                                {{ $getNewSalesCount }}
                            </div>
            ...
            @can('admin_general_dashboard_new_tickets')
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <a href="/admin/students" class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{-- trans('admin/main.new_ticket') --}} Total Enroll Student</h4>
                            </div>
                            <div class="card-body">
                                {{ $getNewTicketsCount }}
                            </div>
            ...
            @can('admin_general_dashboard_new_reviews')
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <a href="/admin/instructors" class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{-- trans('admin/main.pending_review_classes') --}}Total Teacher</h4>
                            </div>
                            <div class="card-body">
                                {{ $getPendingReviewCount }}
                            </div>
