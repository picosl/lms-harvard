            ...
            <div class="col-12 col-lg-4">
                ...
                @else
                    ...
                    <div class="bg-info-light p-10 rounded-sm border">
                        ...
                        <form method="post" enctype="multipart/form-data" action="/course/assignment/{{ $assignment->id }}/history/{{ $assignmentHistory->id }}/message" 
                        onsubmit="return confirm('Are you sure you want to submit the assignment?');">
                            ...
                            <div class="form-group" style="{{ $assignmentHistory->status == 'not_submitted' ? 'display:none;' : 'display:block;' }}">
                                <label class="input-label">{{ trans('public.description') }} ({{ trans('public.optional') }})</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="input-group mr-10">
                                        ...
                                        <input type="file" name="file" id="assignmentAttachmentInput" value="" class="form-control" value="{{ old('file') }}" placeholder="{{ trans('update.assignment_attachments_placeholder') }}"/>
                                  
                                         
                                    </div>

                                    <button type="submit" class="js-save-history-message1 btn btn-primary btn-sm">{{ trans('update.send') }}</button>
                                </div>
                            ...
                            <div class="assignment-attachments-post p-15 border rounded-sm mb-15">
                                ...
                                @if(!empty($message->file_path))
                                    <div class="d-flex flex-wrap align-items-center mt-10">
                                        <a href="{{ $message->getDownloadUrl($assignment->id,$message->sender->full_name) }}" target="_blank" class="d-flex align-items-center text-gray bg-info-light border px-10 py-5 rounded-pill mr-10 mt-5">
