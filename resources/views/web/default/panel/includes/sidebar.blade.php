    ...
    <div class="user-info d-flex align-items-center flex-row flex-lg-column justify-content-lg-center">
        ...
        <div class="d-flex flex-column align-items-center justify-content-center">
            <a href="/panel" class="user-name mt-15">
                <h3 class="font-16 font-weight-bold text-center" style="color:white !important;">{{ $authUser->full_name }}</h3>
            </a>

            @if(!empty($authUser->getUserGroup()))
                <span class="create-new-user mt-10" style="color:white !important;">{{ $authUser->getUserGroup()->name }}</span>
            @endif
        </div>
    </div>
    ...
    <ul id="panel-sidebar-scroll" class="sidebar-menu pt-10 @if(!empty($authUser->userGroup)) has-user-group @endif @if(empty($getPanelSidebarSettings) or empty($getPanelSidebarSettings['background'])) without-bottom-image @endif" @if((!empty($isRtl) and $isRtl)) data-simplebar-direction="rtl" @endif>
        ...
        <li class="sidenav-item {{ (request()->is('panel')) ? 'sidenav-item-active' : '' }}">
            <a href="/panel" class="d-flex align-items-center">
                ...
                <span class="font-14 text-dark-blue font-weight-500" style="color:white !important;">{{ trans('panel.dashboard') }}</span>
            </a>
        </li>
                ...
                <div class="collapse {{ (request()->is('panel/instructors') or request()->is('panel/manage/instructors*')) ? 'show' : '' }}" id="instructorsCollapse">
                    <ul class="sidenav-item-collapse">
                        <li class="mt-5 {{ (request()->is('panel/instructors/new')) ? 'active' : '' }}">
                            <a href="/panel/manage/instructors/new" style="color:white !important;">{{ trans('public.new') }}</a>
                        </li>
                        <li class="mt-5 {{ (request()->is('panel/manage/instructors')) ? 'active' : '' }}">
                            <a href="/panel/manage/instructors" style="color:white !important;">{{ trans('public.list') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
        ...
        <li class="sidenav-item {{ (request()->is('panel/webinars') or request()->is('panel/webinars/*')) ? 'sidenav-item-active' : '' }}">
            <a class="d-flex align-items-center" data-toggle="collapse" href="#webinarCollapse" role="button" aria-expanded="false" aria-controls="webinarCollapse">
                ...
                <span class="font-14 text-dark-blue font-weight-500" style="color:white !important;">{{ trans('panel.webinars') }}</span>
            </a>
                ...
                <ul class="sidenav-item-collapse">
                    @if($authUser->isOrganization() || $authUser->isTeacher())
                        <li class="mt-5 {{ (request()->is('panel/webinars/new')) ? 'active' : '' }}">
                            <a href="/panel/webinars/new" style="color:white !important;">{{ trans('public.new') }}</a>
                        </li>

                        <li class="mt-5 {{ (request()->is('panel/webinars')) ? 'active' : '' }}">
                            <a href="/panel/webinars" style="color:white !important;">{{ trans('panel.my_classes') }}</a>
                        </li>

                        {{--<li class="mt-5 {{ (request()->is('panel/webinars/invitations')) ? 'active' : '' }}">
                            <a href="/panel/webinars/invitations" style="color:white !important;">{{ trans('panel.invited_classes') }}</a>
                        </li>--}}
                    @endif

                    @if(!empty($authUser->organ_id))
                        {{--<li class="mt-5 {{ (request()->is('panel/webinars/organization_classes')) ? 'active' : '' }}">
                            <a href="/panel/webinars/organization_classes" style="color:white !important;">{{ trans('panel.organization_classes') }}</a>
                        </li>--}}
                    @endif

                    @if($authUser->isUser())
                    <li class="mt-5 {{ (request()->is('panel/webinars/purchases')) ? 'active' : '' }}">
                        <a href="/panel/webinars/purchases" style="color:white !important;">{{-- trans('panel.my_purchases') --}} Enrolled Courses</a>
                    </li>
                    @endif
        ...
        {{--Course Instruction--}}
        @if($authUser->isOrganization() or $authUser->isTeacher())
            {{--<li class="sidenav-item {{ (request()->is('panel/course_instruction') or request()->is('panel/course_instruction/*')) ? 'sidenav-item-active' : '' }}">
                <a class="d-flex align-items-center" data-toggle="collapse" href="#bundlesCollapse" role="button" aria-expanded="false" aria-controls="bundlesCollapse">
                <span class="sidenav-item-icon assign-fill mr-10">
                    @include('web.default.panel.includes.sidebar_icons.requests')
                </span>
                    <span class="font-14 text-dark-blue font-weight-500">Course Instruction</span>
                </a>

                <div class="collapse {{ (request()->is('panel/course_instruction') or request()->is('panel/course_instruction/*')) ? 'show' : '' }}" id="bundlesCollapse">
                    <ul class="sidenav-item-collapse">
                        <li class="mt-5 {{ (request()->is('panel/course_instruction/list')) ? 'active' : '' }}">
                            <a href="/panel/course_instruction/list">List</a>
                        </li>
                    </ul>
                </div>
            </li>--}}
        ...
        <li class="sidenav-item {{ (request()->is('panel/assignments') or request()->is('panel/assignments/*')) ? 'sidenav-item-active' : '' }}">
                ...
                <span class="sidenav-item-icon mr-10">
                    ...
                    <span class="font-14 text-dark-blue font-weight-500" style="color:white !important;">{{ trans('update.assignments') }}</span>
                </a>
                ...
                <ul class="sidenav-item-collapse">
                    ...
                    @if($authUser->isUser())
                        <li class="mt-5 {{ (request()->is('panel/assignments/my-assignments')) ? 'active' : '' }}">
                            <a href="/panel/assignments/my-assignments" style="color:white !important;">{{ trans('update.my_assignments') }}</a>
                        </li>
                    @endif

                    @if($authUser->isOrganization() || $authUser->isTeacher())
                        <li class="mt-5 {{ (request()->is('panel/assignments/my-courses-assignments')) ? 'active' : '' }}">
                            <a href="/panel/assignments/my-courses-assignments" style="color:white !important;">{{ trans('update.students_assignments') }}</a>
                        </li>
                    @endif
                </ul>
            </div>
        ...
        <li class="sidenav-item {{ (request()->is('panel/quizzes') or request()->is('panel/quizzes/*')) ? 'sidenav-item-active' : '' }}">
            <a class="d-flex align-items-center" data-toggle="collapse" href="#quizzesCollapse" role="button" aria-expanded="false" aria-controls="quizzesCollapse">
                ...
                <span class="font-14 text-dark-blue font-weight-500" style="color:white !important;">{{ trans('panel.quizzes') }}</span>
            </a>
                ...
                <ul class="sidenav-item-collapse">
                    @if($authUser->isOrganization() || $authUser->isTeacher())
                        <li class="mt-5 {{ (request()->is('panel/quizzes/new')) ? 'active' : '' }}">
                            <a href="/panel/quizzes/new" style="color:white !important;">{{ trans('quiz.new_quiz') }}</a>
                        </li>
                        <li class="mt-5 {{ (request()->is('panel/quizzes')) ? 'active' : '' }}">
                            <a href="/panel/quizzes" style="color:white !important;">{{ trans('public.list') }}</a>
                        </li>
                        <li class="mt-5 {{ (request()->is('panel/quizzes/results')) ? 'active' : '' }}">
                            <a href="/panel/quizzes/results" style="color:white !important;">{{ trans('public.results') }}</a>
                        </li>
                    @endif

                    @if($authUser->isUser())
                        <li class="mt-5 {{ (request()->is('panel/quizzes/my-results')) ? 'active' : '' }}">
                            <a href="/panel/quizzes/my-results" style="color:white !important;">{{ trans('public.my_results') }}</a>
                        </li>
                    @endif

                    @if($authUser->isUser())
                        <li class="mt-5 {{ (request()->is('panel/quizzes/opens')) ? 'active' : '' }}">
                            <a href="/panel/quizzes/opens" style="color:white !important;">{{ trans('public.not_participated') }}</a>
                        </li>
                    @endif
                </ul>
            </div>
        ...
        {{--dd($authUser)--}}
            <li class="sidenav-item {{ (request()->is('panel/notifications')) ? 'sidenav-item-active' : '' }}">
                ...
                <span class="sidenav-notification-icon sidenav-item-icon mr-10">
                    ...
                    <span class="font-14 text-dark-blue font-weight-500" style="color:white !important;">{{ trans('panel.notifications') }}</span>
                </a>
            </li>
        @endif
        ...
        <li class="sidenav-item {{ (request()->is('panel/setting')) ? 'sidenav-item-active' : '' }}">
            <a href="/panel/setting" class="d-flex align-items-center">
                ...
                <span class="font-14 text-dark-blue font-weight-500" style="color:white !important;">{{ trans('panel.settings') }}</span>
            </a>
        </li>
        ...
        @if($authUser->isTeacher() or $authUser->isOrganization())
            <li class="sidenav-item ">
                ...
                <span class="sidenav-item-icon assign-strock mr-10">
                    ...
                    <span class="font-14 text-dark-blue font-weight-500" style="color:white !important;">{{ trans('public.my_profile') }}</span>
                </a>
            </li>
        @endif
        ...
        <li class="sidenav-item">
            <a href="/logout" class="d-flex align-items-center">
                ...
                <span class="font-14 text-dark-blue font-weight-500" style="color:white !important;">{{ trans('panel.log_out') }}</span>
            </a>
        </li>
    </ul>

    @if(!empty($getPanelSidebarSettings) and !empty($getPanelSidebarSettings['background']))
        {{--Ads of Latest Course--}}
