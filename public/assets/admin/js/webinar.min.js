...
!(function (e) {
        ...
        switch ((c.addClass("panel-file-manager"), l.removeClass("d-none"), d.addClass("d-none"), t)) {
            ...
            case "s3":
                r.removeClass("d-none"),
                    a && "video" === a ? o.removeClass("d-none") : (o.find("input").prop("checked", !1), o.addClass("d-none")),
                    "external_link" === t ? ((i = feather.icons["external-link"].toSvg(n)), c.removeClass("panel-file-manager")) : "s3" === t && (l.addClass("d-none"), d.removeClass("d-none")),
                    a && "pdf" === a ? s.removeClass("d-none") : (s.find("input").prop("checked", !1), s.addClass("d-none"));
                break;
            case "google_drive":
                r.removeClass("d-none"),
                    ...
                    o.addClass("d-none"),
                    a && "pdf" === a ? s.removeClass("d-none") : (s.find("input").prop("checked", !1), s.addClass("d-none")),
                    (i = feather.icons.box.toSvg(n)),
                    c.removeClass("panel-file-manager");
                break;
            case "upload":
    ...
    function n(t) {
        ...
        var n = e((a += "</div>"));
        n.find(".js-form-groups").children().remove(),
            n
                .find(".js-form-groups")
                .append(
    ...
    function i(a, i) {
        ...
        e.post("/admin/webinar-extra-description/" + r + "/edit", l, function (t) {
            if (t && t.webinarExtraDescription) {
                ...
                (i += e("#extraDescriptionForm").html()),
                    (i += "</div>"),
                    "company_logos" === a.type && (i = n(s)),
                    (i = i.replaceAll("/admin/webinar-extra-description/store", "/admin/webinar-extra-description/" + r + "/update")),
                    Swal.fire({
                        html: i,
                        showCancelButton: !1,
                        showConfirmButton: !1,
    ...
    function r(t) {
        var a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
            ...
            r = { item_id: i, locale: a };
        e.post("/admin/tickets/" + n + "/edit", r, function (t) {
            if (t && t.ticket) {
                var a = t.ticket,
                    r = '<div id="addTicketModal">';
                (r += e("#webinarTicketModal").html()),
                    (r = (r += "</div>").replaceAll("/admin/tickets/store", "/admin/tickets/" + n + "/update")),
                    Swal.fire({
                        html: r,
                        showCancelButton: !1,
                        showConfirmButton: !1,
                        ...
                        width: "48rem",
                        onOpen: function () {
                            e(".date-range-picker").daterangepicker({ locale: { format: "YYYY-MM-DD" }, drops: "down", opens: "right", startDate: moment(1e3 * a.start_date).toDate(), endDate: moment(1e3 * a.end_date).toDate() }),
                                delete a.start_date,
                                delete a.end_date,
                    ...
                    Swal.fire({
                        ...
                        onOpen: function () {
                            var t = e("#addSessionModal"),
                                a = e(".datetimepicker");
                            a.val(n.date),
                                a.daterangepicker({ locale: { format: "YYYY-MM-DD HH:mm" }, singleDatePicker: !0, timePicker: !0, timePicker24Hour: !0 }),
                                delete n.date,
                                Object.keys(n).forEach(function (e) {
                                    if ("session_api" === e)
                                        t.find('.js-api-input[value="' + n[e] + '"]').prop("checked", !0),
                                            ...
                                            "big_blue_button" === n[e]
                                                ? (t.find(".js-moderator-secret").removeClass("d-none"), t.find(".js-ajax-moderator_secret").prop("disabled", !0))
                                                : "zoom" === n[e]
                                                ? (t.find(".js-local-link").addClass("d-none"), t.find(".js-api-secret").addClass("d-none"), t.find(".js-moderator-secret").addClass("d-none"))
                                                : "agora" === n[e] &&
                                                  (t.find(".js-agora-chat-and-rec").removeClass("d-none"),
                                                  t.find(".js-api-secret").addClass("d-none"),
                                                  t.find(".js-local-link").addClass("d-none"),
                                                  t.find(".js-moderator-secret").addClass("d-none"));
                                    else if ("status" === e) {
                                        var a = "active" === n.status;
                                        t.find('[name="' + e + '"]').prop("checked", a);
                                    } else if ("check_previous_parts" === e || "access_after_day" === e) {
                                        (n.check_previous_parts || null !== n.access_after_day) &&
                                            (t.find(".js-sequence-content-switch").prop("checked", !0),
                                            t.find('[name="check_previous_parts"]').prop("checked", n.check_previous_parts),
                                            t.find('[name="access_after_day"]').val(n.access_after_day),
                                            t.find(".js-sequence-content-inputs").removeClass("d-none"));
                                    } else if ("agora_settings" === e) {
                                        var i = JSON.parse(n.agora_settings);
                                        i && i.chat && (!0 === i.chat || "true" === i.chat) && t.find('[name="agora_chat"]').prop("checked", !0),
    ...
    function l(t) {
        ...
        e.post("/admin/faqs/" + n + "/edit", r, function (t) {
            if (t && t.faq) {
                ...
                (r += e("#webinarFaqModal").html()),
                    (r = (r += "</div>").replaceAll("/admin/faqs/store", "/admin/faqs/" + n + "/update")),
                    Swal.fire({
                        html: r,
                        showCancelButton: !1,
                        showConfirmButton: !1,
    ...
    (e.fn.serializeObject = function () {
        ...
        e("body").on("click", "#webinarAddTicket", function (t) {
            ...
            (a += e("#webinarTicketModal").html()), (a += "</div>"), Swal.fire({ html: a, showCancelButton: !1, showConfirmButton: !1, customClass: { content: "p-0 text-left" }, width: "48rem" }), resetDatePickers();
        }),
        e("body").on("click", "#saveTicket", function (t) {
            t.preventDefault();
            var a = e(this),
                n = e("#addTicketModal form");
        ...
        e(document).ready(function () {
            ...
            function n(a) {
                a.length &&
                    a.sortable({
                        ...
                        axis: "y",
                        update: function (n, i) {
                            var r = a.sortable("toArray", { attribute: "data-id" });
                            !(function (a, n) {
                                e.post("/admin/webinars/order-items", { table: a, items: n }, function (a) {
                                    a && a.title && a.msg && e.toast({ heading: a.title, text: a.msg, bgColor: t, textColor: "white", hideAfter: 1e4, position: "bottom-right", icon: "success" });
                                });
            ...
            if (i.length) {
                var d,
                    c = _createForOfIteratorHelper(i);
                try {
                    for (c.s(); !(d = c.n()).done; ) {
                        var p = d.value,
                            u = e("." + p);
        ...
        e("body").on("change", ".js-webinar-content-locale", function (t) {
            ...
            var d = "/admin/webinars/" + r + "/getContentItemByLocale",
                c = { item_id: o, locale: i, relation: s };
            e.post(d, c, function (t) {
                if (t && t.item) {
                    var i = t.item;
                    Object.keys(i).forEach(function (t) {
                        var a = i[t];
                        -1 !== e.inArray(t, l) && n.find(".js-ajax-" + t).val(a);
                        if ("textLessons" === s && "content" === t) {
                            var r = n.find(".js-content-" + o);
                            r.length &&
                                (r.summernote("destroy"),
                                r.val(a),
                                e(".js-hidden-content-" + o).val(a),
                                r.summernote({
                                    tabsize: 2,
                                    height: 400,
                                    callbacks: {
            ...
            a.addClass("loadingbar primary").prop("disabled", !0),
                ...
                e
                    ...
                    .fail(function (e) {
                        ...
                        n && "zoom_jwt_token_invalid" === n.status && Swal.fire({ icon: "error", html: '<h3 class="font-20 text-center text-dark-blue py-25">' + zoomJwtTokenInvalid + "</h3>", showConfirmButton: !1, width: "25rem" }),
                            n &&
                                n.errors &&
        ...
        e("body").on("click", ".js-add-chapter", function (a) {
            ...
            (c = c.replaceAll("record", l)),
                d.html('<div id="chapterModal' + l + '">' + c + "</div>"),
                Swal.fire({
                    html: d,
                    showCancelButton: !1,
                    showConfirmButton: !1,
                    ...
                    onOpen: function () {
                        ...
                        if ((t.find("input.js-chapter-webinar-id").val(i), t.find("input.js-chapter-type").val(r), o)) {
                            ...
                            t.find(".chapter-form").attr("data-action", a),
                                e.get("/admin/chapters/" + o + "?locale=" + s, function (e) {
                                    if (e && e.chapter) {
        ...
        e("body").on("click", ".js-change-content-chapter", function (a) {
            ...
            l.html('<div id="changeChapterModalHtml' + s + '">' + d + "</div>"),
                Swal.fire({
                    html: l,
                    showCancelButton: !1,
                    showConfirmButton: !1,
        ...
        e("body").on("click", ".js-save-file", function (t) {
            console.log('saving file webinar.min.js in 661');
            t.preventDefault();

            var inputs = document.querySelectorAll('.pl').checked;
            console.log(inputs);
            var a = e(this);
            !(function (t, a) {
        ...
        e("body").on("change", ".js-api-input", function (t) {
            ...
            var a = e(this).closest(".session-form"),
                n = this.value;
            a.find(".js-zoom-not-complete-alert").addClass("d-none"),
                a.find(".js-agora-chat-and-rec").addClass("d-none"),
                "big_blue_button" === n
                    ? (a.find(".js-local-link").addClass("d-none"), a.find(".js-api-secret").removeClass("d-none"), a.find(".js-moderator-secret").removeClass("d-none"))
                    : "zoom" === n
                    ? (a.find(".js-local-link").addClass("d-none"),
                      a.find(".js-api-secret").addClass("d-none"),
                      a.find(".js-moderator-secret").addClass("d-none"),
                      hasZoomApiToken && "true" !== hasZoomApiToken && a.find(".js-zoom-not-complete-alert").removeClass("d-none"))
                    : "agora" === n
                    ? (a.find(".js-agora-chat-and-rec").removeClass("d-none"), a.find(".js-api-secret").addClass("d-none"), a.find(".js-local-link").addClass("d-none"), a.find(".js-moderator-secret").addClass("d-none"))
                    : (a.find(".js-local-link").removeClass("d-none"), a.find(".js-api-secret").removeClass("d-none"), a.find(".js-moderator-secret").addClass("d-none"));
        }),
        ...
        e("body").on("click", ".js-session-has-ended", function () {
            e.toast({ heading: requestFailedLang, text: thisLiveHasEndedLang, bgColor: "#f63c3c", textColor: "white", hideAfter: 1e4, position: "bottom-right", icon: "error" });
        }),
        ...
        e("body").on("click", "#webinarAddPrerequisites", function (t) {
            ...
            (n += e("#webinarPrerequisitesModal").html()),
                (n = (n = (n += "</div>").replaceAll("prerequisites-select", "prerequisites-select2")).replaceAll("str_", "")),
                Swal.fire({
                    html: n,
                    showCancelButton: !1,
                    showConfirmButton: !1,
        ...
        e("body").on("click", "#savePrerequisites", function (t) {
            t.preventDefault();
            var a = e(this),
                n = e("#addPrerequisitesModal form");
            handleWebinarItemForm(n, a);
        }),
        e("body").on("click", "#webinarAddFAQ", function (t) {
            t.preventDefault();
            var a = '<div id="addFAQsModal">';
            (a += e("#webinarFaqModal").html()), (a += "</div>"), Swal.fire({ html: a, showCancelButton: !1, showConfirmButton: !1, customClass: { content: "p-0 text-left" }, width: "48rem" });
        }),
        e("body").on("click", "#saveFAQ", function (t) {
            t.preventDefault();
            var a = e(this),
                n = e("#addFAQsModal form");
            handleWebinarItemForm(n, a);
        }),
        ...
        e("body").on("click", "#saveExtraDescription", function (t) {
            t.preventDefault();
            var a = e(this),
                n = e("#extraDescriptionModal form");
            handleWebinarItemForm(n, a);
        }),
        ...
        e("body").on("click", "#webinarAddQuiz", function (t) {
            ...
            (n += e("#quizzesModal").html()),
                (n = (n += "</div>").replaceAll("quiz-select2", "quiz-select22")),
                Swal.fire({
                    html: n,
                    showCancelButton: !1,
                    showConfirmButton: !1,
                    ...
                    width: "30rem",
                    onOpen: function () {
                        e(".quiz-select22").select2({ placeholder: e(a).data("placeholder"), allowClear: !0, width: "100%" });
                    },
                });
        }),
        ...
        e("body").on("click", ".edit-prerequisite", function (t) {
            ...
            e.post("/admin/prerequisites/" + n + "/edit", r, function (t) {
                ...
                if (t && t.prerequisite) {
                    ...
                    (r += e("#webinarPrerequisitesModal").html()),
                        (r = (r = (r = (r += "</div>").replaceAll("prerequisites-select", "prerequisites-select2")).replaceAll("/admin/prerequisites/store", "/admin/prerequisites/" + n + "/update")).replaceAll("str_", "")),
                        Swal.fire({
                            html: r,
                            showCancelButton: !1,
                            showConfirmButton: !1,
        ...
        e("body").on("click", ".js-get-faq-description", function (t) {
            ...
            Swal.fire({ html: a, showCancelButton: !1, showConfirmButton: !1, customClass: { content: "p-0 text-left" }, width: "30rem" });
        }),
        e("body").on("click", ".edit-webinar-quiz", function (t) {
            ...
            e.post("/admin/webinar-quiz/" + n + "/edit", r, function (t) {
                ...
                if (t && t.webinarQuiz) {
                    ...
                    (r += e("#quizzesModal").html()),
                        (r = (r = (r += "</div>").replaceAll("/admin/webinar-quiz/store", "/admin/webinar-quiz/" + n + "/update")).replaceAll("quiz-select2", "quiz-select22")),
                        Swal.fire({
                            html: r,
                            showCancelButton: !1,
                            showConfirmButton: !1,
                            ...
                            width: "30rem",
                            onOpen: function () {
                                e(".quiz-select22").append('<option selected="selected" value="' + i.id + '">' + i.title + "</option>"),
                                    e(".quiz-select22").select2({ placeholder: e(a).data("placeholder"), allowClear: !0, width: "100%" }),
        ...
        e("body").on("click", "#bundleAddNewCourses", function (t) {
            ...
            (a += e("#bundleWebinarsModal").html()),
                (a = (a = (a += "</div>").replaceAll("bundleWebinars-select", "bundleWebinars-select2")).replaceAll("str_", "")),
                Swal.fire({
                    html: a,
                    showCancelButton: !1,
                    showConfirmButton: !1,
                    ...
                    width: "48rem",
                    onOpen: function () {
                        e(".bundleWebinars-select2").select2({ allowClear: !1 });
                    },
                });
        }),
        e("body").on("click", "#saveBundleWebinar", function (t) {
            t.preventDefault();
            var a = e(this),
                n = e("#addBundleWebinarModal form");
            handleWebinarItemForm(n, a);
        }),
        e("body").on("click", ".edit-bundle-webinar", function (t) {
            ...
            e.post("/admin/bundle-webinars/" + n + "/edit", r, function (t) {
                if (t && t.bundleWebinar) {
                    ...
                    (i += e("#bundleWebinarsModal").html()),
                        (i = (i = (i = (i += "</div>").replaceAll("bundleWebinars-select", "bundleWebinars-select2")).replaceAll("/admin/bundle-webinars/store", "/admin/bundle-webinars/" + n + "/update")).replaceAll("str_", "")),
                        Swal.fire({
                            html: i,
                            showCancelButton: !1,
                            showConfirmButton: !1,
                            ...
                            onOpen: function () {
                                ...
                                t.val(a.webinar_id), t.select2({ allowClear: !1 });
                            },
                        });
                }
            });
