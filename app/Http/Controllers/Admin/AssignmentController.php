            ...
            if (!empty($webinar)) {
                ...
                if ($assignment) {
                    ...
                    if (!empty($assignment->chapter_id)) {
                        WebinarChapterItem::makeItem($webinar->creator_id, $assignment->chapter_id, $assignment->id, WebinarChapterItem::$chapterAssignment,1,1,1);
                    }
                }
