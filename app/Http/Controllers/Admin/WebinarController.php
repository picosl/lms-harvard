...
class WebinarController extends Controller
{
    public function index(Request $request)
    {
        ...
        //$query = Webinar::where('code', 'LIKE', "%$title%");
    ...
    public function course($slug, $justReturnData = false)
    {
        ...
        //dd($course->chapters->chapterItems);
        ...
        return view('admin.webinars.index', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data['downloadable'] = !empty($data['downloadable']) ? true : true;
        $data['partner_instructor'] = !empty($data['partner_instructor']) ? true : false;
        $data['subscribe'] = !empty($data['subscribe']) ? true : false;
        $data['forum'] = !empty($data['forum']) ? true : true;
