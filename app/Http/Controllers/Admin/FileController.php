...
class FileController extends Controller
{
    public function store(Request $request)
    {
        ...
        if (!empty($webinar)) {
            ...
            $file = File::create([
                ...
                'admin_permission' => $admin_p,
                'teacher_permission' => $teacher_p,
                'student_permission' => $student_p,
            ...
            if (!empty($file)) {
                ...
                if (!empty($file->chapter_id)) {
                    WebinarChapterItem::makeItem($file->creator_id, $file->chapter_id, $file->id, WebinarChapterItem::$chapterFile,$file->admin_permission,$file->teacher_permission,$file->student_permission);
                }
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        //dd('st: '.$student_p.' tea: '.$teacher_p.' admin: '.$admin_p);
