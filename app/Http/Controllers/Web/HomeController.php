...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $heroSectionData['title'] = 'In a World of Technology, People Make the Difference.';
        $heroSectionData['description'] = 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s';
        //dd($heroSectionData);
