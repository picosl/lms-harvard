<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown <?php echo e((request()->is('admin/batchs*')) ? 'active' : ''); ?>">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fas fa-graduation-cap"></i>
                    <span>Batchs</span>
                </a>
                <ul class="dropdown-menu">
                    <li class="<?php echo e(request()->is('admin/batchs') ? 'active' : ''); ?>">
                        <a class="nav-link" href="/admin/batchs">Batch List</a>
                    </li>
...
<?php /**PATH /home/wonderit/picolms.wlms.com.au/code/resources/views/admin/includes/sidebar.blade.php ENDPATH**/ ?>