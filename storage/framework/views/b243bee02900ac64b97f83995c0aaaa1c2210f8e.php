        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="/admin/webinars/<?php echo e($webinar->id); ?>/sendNotification" class="form-horizontal form-bordered mt-4">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/admin/webinars/send-notification-to-course-students.blade.php ENDPATH**/ ?>