...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(!empty($user) ? $user->first_name : old('first_name')); ?>" />
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(!empty($user) ? $user->last_name : old('last_name')); ?>" />
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(!empty($user) ? $user->dob : old('dob')); ?>" />
                                            <?php $__errorArgs = ['last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="username"   value="<?php echo e(!empty($user) ? $user->email : old('email')); ?>" aria-describedby="emailHelp">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\PHP\lms\Rocket_LMS\harvard\harvard\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>