                        ...
                        <div class="card-body">
                            ...
                            <div class="row" data-select2-id="select2-data-9-dj9p">
                                <div class="col-12 col-md-6" data-select2-id="select2-data-8-7l60">
                                    <form action="/admin/batchs/<?php echo e($batch->id); ?>/update" method="Post" data-select2-id="select2-data-7-b82u">
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e($batch->batch_name); ?>" required="" />
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group" data-select2-id="select2-data-19-j9q4">
                                            ...
                                            <select name="webinar_id" required="" class="form-control search-webinar-select2 select2-hidden-accessible" data-placeholder="Search classes" data-select2-id="select2-data-3-dl6q" tabindex="-1" aria-hidden="true">
                                                <option value="<?php echo e($batch->webinar_id); ?>" selected><?php echo e($batch->course->slug??""); ?></option>
                                            </select>
                                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e($batch->start_date); ?>" required="" />
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e($batch->end_date); ?>" required="" />
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wlms/public_html/iiet.wlms.com.au/iiet/resources/views/admin/batchs/edit.blade.php ENDPATH**/ ?>