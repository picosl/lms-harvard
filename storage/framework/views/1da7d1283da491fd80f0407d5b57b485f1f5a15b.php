                            ...
                            <tr>
                                ...
                                <td class="align-middle text-right">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_webinar_assignments_conversations')): ?>
                                        <a href="/admin/assignments/<?php echo e($assignment->id); ?>/history/<?php echo e($history->id); ?>/conversations" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.conversations')); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/admin/webinars/assignments/students.blade.php ENDPATH**/ ?>