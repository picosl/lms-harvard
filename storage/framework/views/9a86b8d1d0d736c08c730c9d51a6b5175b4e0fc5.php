                                    ...
                                    <?php if($documents->count() > 0): ?>
                                        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="text-left">
                                                    <div class="text-left">
                                                        ...
                                                        <?php elseif(!empty($document->registration_package_id)): ?>
                                                            <span class="d-block font-weight-bold"><?php echo e(trans('update.purchased_registration_package')); ?></span>
                                                ...
                                                <td>
                                                    <span class="text-success"><?php echo e(addCurrencyToPrice(handlePriceFormat($document->amount))); ?></span>
                                                </td>
