...
<div class="accordion-row rounded-sm border mt-15 p-15">
    <div class="d-flex align-items-center justify-content-between" role="tab" id="files_<?php echo e($file->id); ?>">
        <div class="d-flex align-items-center" href="#collapseFiles<?php echo e($file->id); ?>" aria-controls="collapseFiles<?php echo e($file->id); ?>" data-parent="#<?php echo e($accordionParent); ?>" role="button" data-toggle="collapse" aria-expanded="true">
            ...
            <span class="font-weight-bold text-secondary font-14 file-title" style="color: gray!important;"><?php echo e($file->title); ?>(Type: <?php echo e($file->file_type); ?>)</span>
        </div>
            ...
            <?php if(!empty($user) and $hasBought): ?>
                <div class="d-flex align-items-center mt-20">
                    ...
                    <div class="custom-control custom-switch">
                        <input type="checkbox" <?php if($sequenceContentHasError): ?> disabled <?php endif; ?> id="fileReadToggle<?php echo e($file->id); ?>" data-file-id="<?php echo e($file->id); ?>" value="<?php echo e($course->id); ?>" class="js-file-learning-toggle custom-control-input" <?php if(!empty($file->learningStatus)): ?> checked <?php endif; ?>>
...
<?php /**PATH D:\Project\PHP\lms\Rocket_LMS\harvard\harvard\resources\views/web/default/course/tabs/contents/files.blade.php ENDPATH**/ ?>