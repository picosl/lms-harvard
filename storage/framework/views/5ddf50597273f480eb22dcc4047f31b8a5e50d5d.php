...
unset($__errorArgs, $__bag); ?>" readonly placeholder=""/>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="full_name" value="<?php echo e((!empty($user) and empty($new_user)) ? $user->full_name : old('full_name')); ?>" readonly class="form-control <?php $__errorArgs = ['full_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
<?php /**PATH /home/wlms/harvard.wlms.com.au/harvard/resources/views/web/default/panel/setting/setting_includes/basic_information.blade.php ENDPATH**/ ?>