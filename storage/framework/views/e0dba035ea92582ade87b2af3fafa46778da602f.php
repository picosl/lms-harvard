...
<?php else: ?>
    ...
    <li data-id="<?php echo e(!empty($chapterItem) ? $chapterItem->id :''); ?>" class="accordion-row bg-white rounded-sm border border-gray300 mt-20 py-15 py-lg-30 px-10 px-lg-20">
        <div class="d-flex align-items-center justify-content-between " role="tab" id="file_<?php echo e(!empty($file) ? $file->id :'record'); ?>">
            ...
            <span class="chapter-icon chapter-content-icon mr-10">
                ...
                <div class="font-weight-bold text-dark-blue d-block cursor-pointer"><?php echo e(!empty($file) ? $file->title . ($file->accessibility == 'free' ? " " : '') : trans('public.add_new_files')); ?></div>
            </div>
                ...
                <div class="js-content-form file-form" data-action="/admin/files/<?php echo e(!empty($file) ? $file->id . '/update' : 'store'); ?>">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="form-group mt-20">
                                <label class="cursor-pointer input-label" >User Permission</label>
                                                           
                                <ul class="myclass">
                                    <li>
                                        <label>
                                            <input type="checkbox" name="permissions[]" value="2 " <?php echo e(!empty($file) ? ($file->admin_permission == 1 ? ' checked' : '') : 'new'); ?>  class="pl"><span>&nbsp; Admin</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label>
                                            <input type="checkbox" name="permissions[]" value="4" <?php echo e(!empty($file) ? ($file->teacher_permission == 1 ? ' checked' : '') : 'new'); ?> class="pl"><span>&nbsp; Instructor</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label>
                                            <input type="checkbox" name="permissions[]" value="1" <?php echo e(!empty($file) ? ($file->student_permission == 1 ? ' checked' : '') : 'new'); ?> class="pl"><span>&nbsp; Student</span>
                                        </label>
                                    </li>
                                </ul>                          
                            </div>
                            ...
                            <div class="form-group mt-20">
                                <label class="input-label">Types of File</label>
                                <select name="upload_file_type" class="form-control " id="upload_file_type" required>
                                    <option value="1" <?php if(!empty($file) and $file->upload_file_type == 1): ?> selected <?php endif; ?>>Classroom Learning Guide</option>
                                    <option value="2" <?php if(!empty($file) and $file->upload_file_type == 2): ?> selected <?php endif; ?>>Student Handbook</option>
                    ...
                    <div class="mt-30 d-flex align-items-center">
                        <button type="button" id="saveFileID"  class="js-save-file btn btn-sm btn-primary"><?php echo e(trans('public.save')); ?></button>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /home/wlms/harvard.wlms.com.au/harvard/resources/views/admin/webinars/create_includes/accordions/file.blade.php ENDPATH**/ ?>