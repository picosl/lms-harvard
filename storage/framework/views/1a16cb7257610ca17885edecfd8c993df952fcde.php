<div id="chapterModalHtml" class="d-none">
    <div class="custom-modal-body">
        <h2 class="section-title after-line">New Unit</h2>
        ...
        <div class="js-content-form chapter-form mt-20" data-action="/admin/chapters/store">
            ...
            <div class="form-group">
                <label class="input-label">Unit Code</label>
                <input type="text" name="ajax[chapter][code]" class="form-control js-ajax-title" value=""/>
...
<?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/admin/webinars/create_includes/chapter_modal.blade.php ENDPATH**/ ?>