                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($role->is_admin): ?>
                                                    <span class="text-success fas fa-check">&nbsp;&nbsp;Yes</span>
                                                <?php else: ?>
                                                    <span class="text-danger fas fa-times">&nbsp;&nbsp;No</span>
                                                <?php endif; ?>
                                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wlms/public_html/iiet.wlms.com.au/iiet/resources/views/admin/roles/lists.blade.php ENDPATH**/ ?>