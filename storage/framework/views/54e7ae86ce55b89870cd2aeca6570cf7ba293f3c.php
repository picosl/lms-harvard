                        ...
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <?php if(!empty($quiz->time)): ?>
                                <strong class="font-30 font-weight-bold text-secondary mt-5">
                                    <div class="d-flex align-items-center timer" data-minutes-left="<?php echo e($quiz->time); ?>"></div>
                                </strong>
                            <?php else: ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/web/default/panel/quizzes/start.blade.php ENDPATH**/ ?>