                                ...
                                <div class="col-12 col-md-6" data-select2-id="select2-data-8-7l60">
                                    <form action="/admin/enrollments/store" method="Post" data-select2-id="select2-data-7-b82u">
                                        ...
                                        <div class="form-group" data-select2-id="select2-data-6-yuvt">
                                            ...
                                            <select name="user_id" class="form-control search-user-select2 select2-hidden-accessible" data-placeholder="Search student" data-select2-id="select2-data-1-o95a" tabindex="-1" aria-hidden="true">
                                            </select>
                                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wonderit/iiet.wlms.com.au/iiet/resources/views/admin/enrollment/add_student_to_a_class.blade.php ENDPATH**/ ?>