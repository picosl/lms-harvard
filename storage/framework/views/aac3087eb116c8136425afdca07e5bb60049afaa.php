<div id="multipleQuestionModal" class="<?php echo e(empty($question_edit) ? 'd-none' : ''); ?>">
    <div class="custom-modal-body">
        ...
        <div class="quiz-questions-form" data-action="/admin/quizzes-questions/<?php echo e(empty($question_edit) ? 'store' : $question_edit->id.'/update'); ?>" method="post">
...
<?php /**PATH D:\xampp\htdocs\htdocs\rocketlms-16nulled\codecanyon-33120735-rocket-lms-learning-management-academy-script\Source\Source\resources\views/admin/quizzes/modals/multiple_question.blade.php ENDPATH**/ ?>