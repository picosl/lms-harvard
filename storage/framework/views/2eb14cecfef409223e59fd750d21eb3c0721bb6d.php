...
<a href="<?php echo e((!empty($checkSequenceContent) and $sequenceContentHasError) ? '#!' : $assignmentUrl); ?>" target="<?php echo e($assignmentUrlTarget); ?>" class=" d-flex align-items-start p-10 cursor-pointer <?php echo e((!empty($checkSequenceContent) and $sequenceContentHasError) ? 'js-sequence-content-error-modal' : 'tab-item'); ?> <?php echo e($user->isAdmin() ? 'js-not-access-toast' : ''); ?>"
        ...
        <div class="tab-item-info mt-15">
            ...
            <div class="d-block mt-10 font-12 text-gray">
                ...
                <?php if(!empty($item->deadline)): ?>
                    <?php echo e(dateTimeFormat($item->getDeadlineTimestamp(), 'j M Y')); ?>
...
<?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/web/default/course/learningPage/components/content_tab/assignment-content-tab.blade.php ENDPATH**/ ?>