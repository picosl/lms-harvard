         ...
         <li class="dropdown dropdown-list-toggle">
                ...
                <div class="dropdown-menu dropdown-list dropdown-menu-right">
                    <div class="dropdown-list-icons mb-0" height="150px">
                            <a href="https://wonderit.com.au" class="dropdown-item">
                                <div class="dropdown-item-icon bg-info text-white d-flex align-items-center justify-content-center">
                                    <i class="fa fa-info"></i>
                                </div>
                                <div class="dropdown-item-desc">
                                    Wonder LMS 1.0.0
                                   <div class="time text-primary">All rights reserved for Wonder IT</div>
                                </div>
                            </a>
                    </div>
                </div>
...
<?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/admin/includes/navbar.blade.php ENDPATH**/ ?>