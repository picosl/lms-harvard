...
<?php $__env->startSection('content'); ?>
    ...
    <section class="course-cover-container <?php echo e(empty($activeSpecialOffer) ? 'not-active-special-offer' : ''); ?>">
        <img src="<?php echo e(!empty($course->getImageCover()) ? $course->getImageCover() : $si); ?>" class="img-cover course-cover-img" alt="<?php echo e($course->title); ?>"/>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/web/default/course/index.blade.php ENDPATH**/ ?>