...
<section class="p-15 m-15 border rounded-lg">
    <div class="assignment-top-stats d-flex flex-wrap flex-md-nowrap align-items-center justify-content-around">
        ...
        <?php if(!empty($assignment) && $assignment->marking_type == 1): ?>
        <div class="assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
            ...
            <div class="col-12 col-lg-4">
                ...
                <?php else: ?>
                    ...
                    <div class="bg-info-light p-10 rounded-sm border">
                        ...
                        <form method="post" enctype="multipart/form-data" action="/course/assignment/<?php echo e($assignment->id); ?>/history/<?php echo e($assignmentHistory->id); ?>/message" 
                        onsubmit="return confirm('Are you sure you want to submit the assignment?');">
                            ...
                            <div class="form-group" style="<?php echo e($assignmentHistory->status == 'not_submitted' ? 'display:none;' : 'display:block;'); ?>">
                                <label class="input-label"><?php echo e(trans('public.description')); ?> (<?php echo e(trans('public.optional')); ?>)</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="input-group mr-10">
                                        ...
                                        <input type="file" name="file" id="assignmentAttachmentInput" value="" class="form-control" value="<?php echo e(old('file')); ?>" placeholder="<?php echo e(trans('update.assignment_attachments_placeholder')); ?>"/>
                                  
                                         
                                    </div>

                                    <button type="submit" class="js-save-history-message1 btn btn-primary btn-sm"><?php echo e(trans('update.send')); ?></button>
                                </div>
                    ...
                    <?php if($user->id == $assignment->creator_id): ?>
                        <div class="bg-info-light p-10 rounded-sm border mt-15">
                            ...
                            <form method="post" action="/course/assignment/<?php echo e($assignment->id); ?>/history/<?php echo e($assignmentHistory->id); ?>/setGrade">
                                ...
                                <?php if($assignment->marking_type == 1): ?>
                                <div class="form-group">
                                    ...
                                    <div class="d-flex align-items-start">
                                        <div class="mr-10 w-100">
                                            <label class="form-check-label">
                                                <input type="radio" id="marking_system" name="radio" value="satisfied" onclick="" > Satisfied</input>
                                            </label><br>
                                            <label class="form-check-label">
                                                <input type="radio" id="marking_system" name="radio" value="not_satisfied" > Not Satisfied</input>
                                            </label>
                                            <div class="invalid-feedback"></div>
                                        </div>
                            ...
                            <div class="assignment-attachments-post p-15 border rounded-sm mb-15">
                                ...
                                <?php if(!empty($message->file_path)): ?>
                                    <div class="d-flex flex-wrap align-items-center mt-10">
                                        <a href="<?php echo e($message->getDownloadUrl($assignment->id,$message->sender->full_name)); ?>" target="_blank" class="d-flex align-items-center text-gray bg-info-light border px-10 py-5 rounded-pill mr-10 mt-5">
...
<script>
        function confirmSubmit() {
            return confirm('Are you sure you want to submit the assignment?');
        }
</script
<?php $__env->stopSection(); ?>
<?php /**PATH /home/wlms/public_html/iiet.wlms.com.au/iiet/resources/views/web/default/course/learningPage/components/assignment.blade.php ENDPATH**/ ?>