...
<?php $__env->startSection('content'); ?>
    <div class="">
        ...
        <form method="post" action="/panel/bundles/<?php echo e(!empty($bundle) ? $bundle->id .'/update' : 'store'); ?>" id="webinarForm" class="webinar-form">
        ...
        <div class="create-bundle-footer d-flex flex-column flex-md-row align-items-center justify-content-between mt-20 pt-15 border-top">
            ...
            <div class="mt-20 mt-md-0">
                ...
                <?php if(!empty($bundle) and $bundle->creator_id == $authUser->id): ?>
                    <a href="/panel/bundles/<?php echo e($bundle->id); ?>/delete?redirect_to=/panel/bundles" class="delete-action bundle-actions btn btn-sm btn-danger mt-20 mt-md-0"><?php echo e(trans('public.delete')); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/web/default/panel/bundle/create.blade.php ENDPATH**/ ?>