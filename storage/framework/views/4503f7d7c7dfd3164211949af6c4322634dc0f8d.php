    ...
    <section class="">
        <div class="col-12">
            <div class="dashboard-banner" style="height: 255px;">
                <img src="<?php echo e($generalSettings['logo']); ?>" class="rto-logo" alt="site logo" >
            </div>
        </div>
    </section>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\PHP\lms\Rocket_LMS\harvard\harvard\resources\views/web/default/panel/dashboard.blade.php ENDPATH**/ ?>