            ...
            <table class="table table-striped font-14">
                ...
                <?php $__currentLoopData = $navbarButtons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e(!empty($row->role) ? $row->role->caption : ''); ?></td>
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_settings_personalization')): ?>
                                <a href="/admin/settings/personalization/navbar_button/<?php echo e($row->id); ?>/edit" class="btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
                                    <i class="fa fa-edit"></i>
                                </a>
                            <?php endif; ?>

                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_settings_personalization')): ?>
                                <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/settings/personalization/navbar_button/'. $row->id .'/delete' , 'btnClass' => 'btn-sm'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/admin/settings/personalization/navbar_button.blade.php ENDPATH**/ ?>