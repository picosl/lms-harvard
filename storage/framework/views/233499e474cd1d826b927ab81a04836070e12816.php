                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    <?php $__currentLoopData = $discounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($discount->max_amount ?  addCurrencyToPrice($discount->max_amount) : '-'); ?></td>
                                            <td><?php echo e($discount->amount ?  addCurrencyToPrice($discount->amount) : '-'); ?></td>
                                            <td><?php echo e($discount->minimum_order ?  addCurrencyToPrice($discount->minimum_order) : '-'); ?></td>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_discount_codes_edit')): ?>
                                                    <a href="/admin/financial/discounts/<?php echo e($discount->id); ?>/edit" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                <?php endif; ?>

                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_discount_codes_delete')): ?>
                                                    <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/financial/discounts/'. $discount->id.'/delete','btnClass' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\htdocs\rocketlms-16nulled\codecanyon-33120735-rocket-lms-learning-management-academy-script\Source\Source\resources\views/admin/financial/discount/lists.blade.php ENDPATH**/ ?>