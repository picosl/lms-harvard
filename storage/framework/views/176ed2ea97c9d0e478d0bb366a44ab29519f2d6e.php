...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/vue-select.css')); ?>">
    <?php if($isRtl): ?>
    ...
    <script src="<?php echo e(asset('ViewerJS/vue-select.js')); ?>"></script>
    <script defer src="<?php echo e(asset('ViewerJS/compact-layout.js')); ?>"></script>
    <script src="<?php echo e(asset('ViewerJS/vue.js')); ?>"></script>
    <script src="<?php echo e(asset('ViewerJS/vuejs-datepicker.min.js')); ?>"></script>
...
<?php /**PATH D:\Project\PHP\lms\Rocket_LMS\harvard\harvard\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>