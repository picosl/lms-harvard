...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <label><?php echo e(trans('admin/main.title')); ?></label>
                            <input type="text" name="value[button1][title]" value="<?php echo e((!empty($itemValue) and !empty($itemValue['button1'])) ? $itemValue['button1']['title'] : ''); ?>" class="form-control "/>
                        </div>
                        <div class="col-6">
                            <label><?php echo e(trans('admin/main.link')); ?></label>
                            <input type="text" name="value[button1][link]" value="<?php echo e((!empty($itemValue) and !empty($itemValue['button1'])) ? $itemValue['button1']['link'] : ''); ?>" class="form-control "/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <label><?php echo e(trans('admin/main.title')); ?></label>
                            <input type="text" name="value[button2][title]" value="<?php echo e((!empty($itemValue) and !empty($itemValue['button2'])) ? $itemValue['button2']['title'] : ''); ?>" class="form-control "/>
                        </div>
                        <div class="col-6">
                            <label><?php echo e(trans('admin/main.link')); ?></label>
                            <input type="text" name="value[button2][link]" value="<?php echo e((!empty($itemValue) and !empty($itemValue['button2'])) ? $itemValue['button2']['link'] : ''); ?>" class="form-control "/>
                        </div>
                    </div>
                </div>
...
<?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/admin/settings/personalization/find_instructors.blade.php ENDPATH**/ ?>