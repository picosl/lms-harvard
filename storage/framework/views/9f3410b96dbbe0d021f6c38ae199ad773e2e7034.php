                                    ...
                                    <form action="/admin/enrollments/store" method="Post" data-select2-id="select2-data-7-b82u">
                                        ...
                                        <div class="form-group" data-select2-id="select2-data-19-j9q4">
                                            ...
                                            <select name="webinar_id" class="form-control select2" data-placeholder="Search classes" data-select2-id="select2-data-3-dl6q" tabindex="-1" aria-hidden="true">
                                                ...
                                                <option value="<?php echo e($course->id); ?>"><?php echo e($course->getTitleAttribute()); ?></option>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wlms/iiet.wlms.com.au/iiet/resources/views/admin/enrollment/add_student_to_a_class.blade.php ENDPATH**/ ?>