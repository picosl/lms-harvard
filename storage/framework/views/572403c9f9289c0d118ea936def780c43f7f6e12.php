<section class="mt-50">
    <div class="">
        <h2 class="section-title after-line">Units</h2>
    </div>

    <button type="button" class="js-add-chapter btn btn-primary btn-sm mt-15" data-webinar-id="<?php echo e($webinar->id); ?>">New Unit</button>
...
<?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/admin/webinars/create_includes/contents.blade.php ENDPATH**/ ?>