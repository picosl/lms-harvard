<?php $__env->startSection('content'); ?>
    <div class="container">
        <section class="mt-40">
            <h2 class="font-weight-bold font-16 text-dark-blue"><?php echo e($quizResult->quiz->title); ?></h2>
            <p class="text-gray font-14 mt-5">
                <a href="<?php echo e($quizResult->quiz->webinar->getUrl()); ?>" target="_blank" class="text-gray"><?php echo e($quizResult->quiz->webinar->title); ?></a>
                | <?php echo e(trans('public.by')); ?>

                <span class="font-weight-bold">
                    <a href="<?php echo e($quizResult->quiz->creator->getProfileUrl()); ?>" target="_blank" class=""> <?php echo e($quizResult->quiz->creator->full_name); ?></a>
                </span>
            </p>
                ...
                <div class="row">
                    <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <strong class="font-30 font-weight-bold text-secondary mt-5"><?php echo e($quizResult->quiz->pass_mark); ?>/<?php echo e($questionsSumGrade); ?></strong>
                    ...
                    <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <strong class="font-30 font-weight-bold text-secondary mt-5"><?php echo e($numberOfAttempt); ?>/<?php echo e($quizResult->quiz->attempt); ?></strong>
        ...
        <section class="mt-30 quiz-form">
            <form action="<?php echo e(!empty($newQuizStart) ? '/panel/quizzes/'. $newQuizStart->quiz->id .'/update-result' : ''); ?> " method="post">
                ...
                <input type="hidden" class="js-quiz-question-count" value="<?php echo e($quizResult->quiz->quizQuestions->count()); ?>"/>

                <?php $__currentLoopData = $quizResult->quiz->quizQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="rounded-lg shadow-sm py-25 px-20">
                            <div class="quiz-card">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="rounded-sm border border-gray200 p-15 text-gray"><?php echo e($key + 1); ?>/<?php echo e($quizResult->quiz->quizQuestions->count()); ?></div>
                                </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/web/default/panel/quizzes/quiz_result.blade.php ENDPATH**/ ?>