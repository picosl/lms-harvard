                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_support_departments_edit')): ?>
                                                        <a href="/admin/supports/departments/<?php echo e($department->id); ?>/edit" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                    <?php endif; ?>

                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_support_departments_delete')): ?>
                                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/supports/departments/'. $department->id.'/delete','btnClass' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\htdocs\rocketlms-16nulled\codecanyon-33120735-rocket-lms-learning-management-academy-script\Source\Source\resources\views/admin/supports/departments.blade.php ENDPATH**/ ?>