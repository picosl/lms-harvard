...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center mt-20">
            <span class="text-secondary">
                <a href="/admin/login" class="font-weight-bold"><?php echo e(trans('auth.login')); ?></a>
            </span>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.auth.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wonderit/public_html/aston/code/resources/views/admin/auth/forgot_password.blade.php ENDPATH**/ ?>