                        ...
                        <div class="card-body">
                            ...
                            <div class="row" data-select2-id="select2-data-9-dj9p">
                                <div class="col-12 col-md-6" data-select2-id="select2-data-8-7l60">
                                    <form action="/admin/batchs/store" method="Post" data-select2-id="select2-data-7-b82u">
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('batch_name')); ?>" required="" />
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\PHP\lms\Rocket_LMS\harvard\harvard\resources\views/admin/batchs/create.blade.php ENDPATH**/ ?>