            ...
            <div class="js-content-form assignment-form" data-action="/admin/assignments/<?php echo e(!empty($assignment) ? $assignment->id . '/update' : 'store'); ?>">
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="input-label">Marking System<span style="color:red;">*</span></label><br>
                            <label class="form-check-label">
                                <input type="radio" id="marking_system" name="ajax[<?php echo e(!empty($assignment) ? $assignment->id : 'new'); ?>][radio]" value="grading" onclick="check(this.value)" <?php echo e(!empty($assignment) ? (($assignment->marking_type == "1") ? "checked" : "") : ""); ?>> Grading</input>
                            </label><br>
                            <label class="form-check-label">
                                <input type="radio" id="marking_system" name="ajax[<?php echo e(!empty($assignment) ? $assignment->id : 'new'); ?>][radio]" value="others" onclick="check(this.value)" <?php echo e(!empty($assignment) ? (($assignment->marking_type == "0") ? "checked" : "") : ""); ?>> Satisfied/Unsatisfied</input>
                            </label>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="form-group grade">
                            <label class="input-label"><?php echo e(trans('quiz.grade')); ?><span style="color:red;">*</span></label>
                        ...
                        <div class="form-group pass_grade">
                            <label class="input-label"><?php echo e(trans('update.pass_grade')); ?><span style="color:red;">*</span></label>
                        ...
                        <div class="form-group">
                            <label class="input-label"><?php echo e(trans('update.deadline')); ?>(in days)</label>
                        ...
                        <div class="form-group mt-20">
                            <div class="d-flex align-items-center justify-content-between">
                                <label class="cursor-pointer input-label" for="assignmentStatusSwitch<?php echo e(!empty($assignment) ? $assignment->id : '_record'); ?>"><?php echo e(trans('public.active')); ?><span style="color:red;">*</span></label>
...
<?php /**PATH D:\xampp\htdocs\htdocs\code Backup-09-08-2022\code\resources\views/admin/webinars/create_includes/accordions/assignment.blade.php ENDPATH**/ ?>