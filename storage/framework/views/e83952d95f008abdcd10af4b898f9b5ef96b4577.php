                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media-body">
                                            <div class=" mt-0 mb-1 font-weight-bold"><?php echo e($currency); ?><?php echo e(number_format($appointment->paid_amount, 2, ".", "")+0); ?></div>
                                        </div>
                                    </td>

                                    <td class="text-center"><?php echo e($appointment->meetingTime->time); ?></td>

                                    <td class="text-center"><?php echo e(dateTimeFormat(strtotime($appointment->day), 'd M Y')); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\htdocs\rocketlms-16nulled\codecanyon-33120735-rocket-lms-learning-management-academy-script\Source\Source\resources\views/admin/appointments/lists.blade.php ENDPATH**/ ?>