                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="title" type="text" class="form-control" value="<?php echo e(request()->get('title')); ?>" placeholder="code">
                                </div>
                            </div>
                                ...
                                <table class="table table-striped font-14 ">
                                    ...
                                    <?php $__currentLoopData = $webinars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $webinar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-center">
                                            <td><?php echo e($webinar->code); ?></td>
                                            <td width="18%" class="text-left">
                                                <a class="text-primary mt-0 mb-1 font-weight-bold" href="<?php echo e($webinar->getAdminUrl()); ?>"><?php echo e($webinar->title); ?></a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\PHP\lms\Rocket_LMS\harvard\harvard\resources\views/admin/webinars/lists.blade.php ENDPATH**/ ?>