...
unset($__errorArgs, $__bag); ?>">
                                                    ...
                                                    <option><?php echo e(trans('product.text_course')); ?></option>
                                                </select>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="points" value="<?php echo e(!empty($webinar) ? $webinar->points : old('points')); ?>" class="form-control <?php $__errorArgs = ['points'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                <label class="" for="certificateSwitch"><?php echo e(trans('update.include_certificate')); ?></label>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="certificate" class="custom-control-input" id="certificateSwitch" <?php echo e(!empty($webinar) && $webinar->certificate ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\htdocs\rocketlms-16nulled\codecanyon-33120735-rocket-lms-learning-management-academy-script\Source\Source\resources\views/admin/webinars/create.blade.php ENDPATH**/ ?>