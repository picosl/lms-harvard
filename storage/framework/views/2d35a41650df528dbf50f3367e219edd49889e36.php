                        ...
                        <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                <td class="text-left">
                                    ...
                                    <span class="d-block font-weight-500 text-gray"><?php echo e($assignment->webinar->title ?? ''); ?>(<?php echo e($assignment->webinar->code ?? ""); ?>)</span>
                                </td>
                                
                                <td class="align-middle">
                                    <span class="font-weight-500"><?php echo e($assignment->chapter->title ?? ""); ?>(<?php echo e($assignment->chapter->code ?? ""); ?>)</span>
                                </td>
                                
                                <td class="align-middle">
                                    <span class="font-weight-500"><?php echo e($assignment->title ?? ''); ?></span>
                                </td>
                                
                                <td class="align-middle">
                                    <span class="font-weight-500"><?php echo e(count($assignment->attachments) ? getFileExtension($assignment->attachments[0]->attach) : ''); ?></span>
                                </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wlms/public_html/iiet.wlms.com.au/iiet/resources/views/admin/webinars/assignments/lists.blade.php ENDPATH**/ ?>